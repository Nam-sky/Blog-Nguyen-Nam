...
Route::get('bai-viet-tam-su','HomeController@baiviettamsu')->name('home.baiviettamsu');

Route::get('blog/{id}/{blog_name}','HomeController@blogdetail')->name('home.blogdetail');
